...
export class OwnUserStore {
    ...
    @initialize @bind @action public async loadUser() {
    ...
    @bind private storeFollower(followership: Followership) {
        this.followers.set(followership.id, followership);
    }

    @bind private storeFollowing(fllowership: Followership) {
    ...
    @bind @action public async addFollowing(userId: string) {
    ...
    @bind @action public async updateUser(password: string, renderingStrategy: string) {
